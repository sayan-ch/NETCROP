...
records <- run_simulations(one_simulation, nsim = nsim,
  results_file = file.path(output_dir, "case4_dcbmK20.rds"), action = "resume",
...
if (length(tables)) utils::write.csv(do.call(rbind, tables), file.path(output_dir, "case4_dcbmK20.csv"), row.names = FALSE)
