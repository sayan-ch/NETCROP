...
run_name <- "case3_d5_a0"; output_dir <- file.path(script_dir,"output",run_name); dir.create(output_dir,recursive=TRUE,showWarnings=FALSE)
...
nsim <- 100L; n <- 1000L; d <- 5L; alpha <- 0; d_candidates <- 1:10; losses <- "sse"
